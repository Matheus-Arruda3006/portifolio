  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        <Link to='/' className='flex items-center gap-2' onClik={() => {
          setActive('');
          window.scrollTo(0,0);
        }}>
          <img src={logo} alt='logo' className='w-9 h9 object-contain'/>
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Matheus de Arruda &nbsp; <span className='sm:block hidden'>| Software Engineer</span></p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
            ...
            <div className={`${!toggle ? "hidden" : "flex"} p-6 black-gradiant absolute top-20 right-0 mx-4 my-2 min-width-[140px]`}>
